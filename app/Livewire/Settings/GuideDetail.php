        ...
        $data = [
            ...
            'settings' => [
                ...
                'procedures' => [
                    ...
                    ['title' => 'Konfigurasi Email (SMTP) Struk & Backup Mingguan', 'desc' => "1. Buka halaman <a href=\"/settings/store\" class=\"text-blue-600 hover:underline font-bold\">Pengaturan Toko</a>, gulir ke bagian **Pengaturan Email (SMTP)**.\n2. **Email Pengirim Struk / Notifikasi**: Isi email pengirim nota kasir (misal `ampotek9@gmail.com`).\n3. **Email Penerima Backup Database**: Isi email milik Pemilik/Owner yang khusus menerima file backup database & laporan mingguan (misal `ampotek9@gmail.com`).\n4. **Nama Pengirim Struk**: Isi nama toko Anda (misal `Am Apotek System` atau `Arrohmah Medica`).\n5. **Username Email (SMTP)**: Isi alamat email Gmail pengirim (`ampotek9@gmail.com`).\n6. **Password Aplikasi (SMTP)**: Masukkan kode **16 karakter App Password** dari Google (Buka **myaccount.google.com** dari akun `ampotek9@gmail.com` → **Keamanan** → **Verifikasi 2 Langkah** → **Password Aplikasi** → Buat nama aplikasi lalu salin 16 karakter tanpa spasi).\n7. **Host SMTP**: `smtp.gmail.com`, **Port**: `587`, **Enkripsi**: `tls`.\n8. Klik **Simpan Perubahan** di bagian bawah."],
