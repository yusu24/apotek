...
$classes = ($active ?? false)
            ? 'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold bg-blue-600 text-white transition-colors'
            : 'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-semibold text-white hover:bg-blue-800 hover:text-white transition-colors';
