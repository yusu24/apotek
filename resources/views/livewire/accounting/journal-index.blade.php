<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-3">
            @can('create journal')
            <a href="{{ route('accounting.journals.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-bold transition flex items-center gap-2">
