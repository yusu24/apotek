        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-gray-100">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4 bg-gray-50 p-3 rounded-lg border border-gray-100">
                        ...
                        <div class="flex gap-2">
                            ...
                            @if($categoryEditId)
                                <button box-type="button" wire:click="cancelEditCategory" 
                            ...
                            @foreach($allCategories as $cat)
                                <div class="p-3 flex justify-between items-center hover:bg-gray-50 transition-colors">
                                    ...
                                    <div class="flex items-center gap-1">
                                        <button wire:click="editCategory({{ $cat->id }})" class="p-1 text-blue-500 hover:bg-blue-50 rounded transition-colors" title="Edit">
                                        ...
                                        <button wire:click="deleteCategory({{ $cat->id }})" 
                                            ...
                                            class="p-1 text-red-500 hover:bg-red-50 rounded transition-colors" title="Hapus">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 flex justify-end">
                    <button wire:click="$set('showCategoryModal', false)" type="button" class="w-full inline-flex justify-center rounded-lg border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 sm:w-auto sm:text-sm">
                        Tutup
                    </button>
                </div>
            </div>
