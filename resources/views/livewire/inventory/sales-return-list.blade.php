    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-4 border-b border-gray-100 bg-gray-50/50 flex flex-row justify-between items-center gap-4">
            <div class="relative flex-1 sm:flex-none">
                ...
                <input type="text" wire:model.live="search" placeholder="Cari No. Retur atau No. Invoice..." class="block w-full sm:w-48 pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm">
            </div>
