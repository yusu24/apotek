<div class="p-6">
    ...
    @if (session()->has('message'))
        <div class="mb-6 bg-green-50 border-l-4 border-green-400 p-4 shadow-sm animate-in fade-in duration-300">
            <div class="flex">
    ...
    @if (session()->has('error'))
        <div class="mb-6 bg-red-50 border-l-4 border-red-400 p-4 shadow-sm animate-in fade-in duration-300">
            <div class="flex">
                <div class="flex-shrink-0">
            ...
            <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto flex-1 md:items-center">
                <div class="flex gap-2 shrink-0">
                    <a href="{{ route('inventory.index', ['filter_status' => 'all']) }}" wire:navigate 
                        class="btn {{ $filter_status == 'all' ? 'btn-primary' : 'bg-white border border-gray-300 text-gray-600 hover:bg-gray-50' }} text-sm py-2">
                        Semua
                    </a>
                    <a href="{{ route('inventory.index', ['filter_status' => 'low_stock']) }}" wire:navigate 
                        class="btn {{ $filter_status == 'low_stock' ? 'btn-primary' : 'bg-white border border-gray-300 text-gray-600 hover:bg-gray-50' }} text-sm py-2">
                        Stok Menipis
                    </a>
                </div>
                        ...
                        <tr wire:key="product-{{ $product->id }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    @can('adjust stock')
                                        <a href="{{ route('inventory.adjust', $product->id) }}" wire:navigate
                                            class="text-green-600 hover:text-green-900 transition-colors" title="Penyesuaian Stok (Semua Batch)">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <style>
        @media print {
            ...
            .bg-white, .bg-gray-50 { background-color: transparent !important; }
