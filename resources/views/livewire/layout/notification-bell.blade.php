<div class="relative" x-data="{ open: false }">
    ...
    <button type="button" @click="open = !open" 
            class="{{ $iconOnly ? 'p-1.5' : 'w-full flex items-center px-3 py-2 gap-3' }} rounded-lg text-sm font-medium text-white hover:bg-gray-800/50 xl:hover:bg-gray-800 hover:text-white transition-colors group">
    ...
    <div x-show="open" 
         ...
         class="absolute {{ $direction === 'down' ? 'top-full mt-2' : 'bottom-full mb-2' }} right-0 xl:right-auto xl:left-0 w-72 bg-gray-900 border border-gray-800 rounded-xl shadow-2xl z-[100] overflow-hidden"
