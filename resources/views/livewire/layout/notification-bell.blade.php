...
@endphp
    ...
    <div x-show="open" 
         ...
         class="absolute {{ $direction === 'down' ? 'top-full mt-2' : 'bottom-full mb-2' }} right-0 {{ $textColor === 'text-white' ? 'xl:right-auto xl:left-0' : 'xl:right-0' }} w-72 bg-gray-900 border border-gray-800 rounded-xl shadow-2xl z-[100] overflow-hidden"
