        ...
        <div class="p-4 border-b bg-gray-50">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto flex-1 md:items-center">
                    ...
                    <div class="relative w-full md:w-64">
                        ...
                        <input type="text" wire:model.live="search" placeholder="Cari obat..." 
                            class="block w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm shadow-sm transition-all focus:bg-white">
                    </div>
                ...
                <div class="flex gap-2 w-full md:w-auto justify-end items-center">
                    @can('create products')
                    <a href="{{ route('products.create') }}" wire:navigate class="btn btn-primary" title="Tambah">
