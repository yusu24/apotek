    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-4 border-b border-gray-100 bg-gray-50/50 flex flex-row items-center justify-between gap-4">
            <div class="relative w-full md:w-64">
                ...
                <input type="text" wire:model.live="search" class="block w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm shadow-sm" placeholder="Cari nama satuan...">
            </div>

            <button wire:click="openModal" class="btn btn-primary shrink-0" title="Tambah Unit">
