                    ...
                    @forelse($receipts as $gr)
                        <tr wire:key="receipt-{{ $gr->id }}">
                            ...
                            <td class="px-6 py-4 text-sm text-right">
                                <button wire:click="showDetail({{ $gr->id }})" class="text-blue-600 hover:text-blue-900 transition-colors duration-200 p-1 rounded-full hover:bg-blue-50" title="Lihat Detail">
