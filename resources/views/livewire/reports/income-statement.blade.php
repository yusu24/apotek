<div class="p-6 space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Laporan Pendapatan & Beban • Terupdate: {{ now()->format('H:i:s') }}</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 relative">
        ...
        <div class="flex flex-col md:flex-row gap-4 items-end">
            ...
            <div class="w-full md:w-auto flex flex-row gap-2">
                ...
                <a href="{{ route('excel.income-statement', ['startDate' => $startDate, 'endDate' => $endDate]) }}" target="_blank" class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 shadow-md font-bold text-sm flex items-center justify-center gap-2 transition duration-200" title="Export Excel">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
