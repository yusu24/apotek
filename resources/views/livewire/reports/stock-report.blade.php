                ...
                <div class="px-6 py-4 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 no-print">
                    <div class="flex flex-row items-center gap-3">
                        ...
                        <div class="flex-shrink-0 ml-auto">
                            <button onclick="window.print()" class="flex items-center gap-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-all font-bold text-[10px] uppercase tracking-wider whitespace-nowrap">
