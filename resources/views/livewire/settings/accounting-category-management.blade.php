        ...
        <div class="mb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="relative w-full md:w-64">
                ...
                <input type="text" wire:model.live="search" placeholder="Cari kategori..." 
                    class="block w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500 transition duration-150">
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <x-empty-table colspan="6" message="Belum ada kategori akuntansi." icon="document" />
                    @endforelse
                </tbody>
            </table>
        </div>
