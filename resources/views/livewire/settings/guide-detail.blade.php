                    ...
                    <div class="flex items-start justify-between mb-8" id="overview">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('pdf.user-manual') }}" 
                               class="flex-shrink-0 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 shadow-md font-bold text-sm flex items-center justify-center gap-2 transition duration-200">
