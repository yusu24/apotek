    ...
    <form wire:submit="save">
        <div class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div x-data="{ showPassword: false }">
                                ...
                                <div class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" wire:model="mail_password" placeholder="Gunakan App Password" class="block w-full pr-10 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 transition-colors focus:outline-none" title="Lihat/Sembunyikan Password">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <x-button type="submit" variant="primary" class="w-full flex items-center justify-center gap-2">
