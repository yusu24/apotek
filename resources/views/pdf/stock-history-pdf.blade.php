...
<head>
    ...
    <style>
        ...
        .header-table { width: 100%; border-collapse: collapse; margin: 0 auto 15px auto; table-layout: auto !important; border-bottom: 3px solid #2563eb; padding-bottom: 12px; }
